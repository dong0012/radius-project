        ...
        <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between w-full min-h-screen p-4 ">
            ...
            <div className="w-full md:w-1/2 p-4 fs-12 ml-[5%]">
                ...
                <p className="text-base">
                    All of our radius maps are created to the highest quality and scale using GIS, AutoCAD, and various
                    other types of mapping software.
                </p>
                <br />
                <p className="text-base">
                    We provide accurate maps of any size radius. (100 ft radius (100'), 300 ft radius (300'), 500 ft
                    radius (500'), 1000 ft radius (1000'), etc.)
                </p>
                <br />
                ...
                <p className="text-base">- Location Maps</p>
